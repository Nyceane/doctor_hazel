...
DEFAULT_PROTOTXT = "HazelNet/caffenet_deploy_1.prototxt"
DEFAULT_MODEL    = "HazelNet/caffe_model_1_iter_1250.caffemodel"
DEFAULT_LABELS   = "HazelNet/labels.txt"
DEFAULT_MEAN     = "HazelNet/mean.binaryproto"

windowName = "Doctor Hazel"
...
def open_window(windowName, width, height):
    ...
    cv2.setWindowTitle(windowName, "Doctor Hazel")
